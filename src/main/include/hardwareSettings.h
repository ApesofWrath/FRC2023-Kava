...
class hardwareSettings {
    ...
    //*rev::CANSparkMax motorDrive;
    //*rev::CANSparkMax motorTurn;
	...
	hardwareSettings() {
        ...
        //TalonFX
        //*motorTurn.primaryPID.selectedFeedbackSensor = ctre::phoenix::motorcontrol::FeedbackDevice::IntegratedSensor;
        //-motorTurn.primaryPID.selectedFeedbackCoefficient = 1.0;
        //-motorTurn.closedloopRamp = 0.0;
        //*motorTurn.peakOutputForward = 1.0F; //0.15
        //*motorTurn.peakOutputReverse = -1.0F; //0.15
        //-motorTurn.nominalOutputForward = 0.03F;
        //-motorTurn.nominalOutputReverse = -0.03F;
        ...
        //*motorTurn.slot0.kP = 0.55; //0.7
        //*motorTurn.slot0.kI = 0.0; //0.0
        //*motorTurn.slot0.kD = 0.3; //0.3
        ...
        //-ctre::phoenix::motorcontrol::SupplyCurrentLimitConfiguration supplyLimitB(true, 20.0, 21.9, 1.4);
